...
const otherProseChildren = [
  [
    <h2>هاوەڵکاری چۆنێتی مەشکێنە</h2>,
    <>
      <p>
        هاوەڵکاری چۆنێتی دەبێت بەیەکەوە بنووسرێت و نابێت بەشەکانی لێک جیا
        بکرێنەوە.
      </p>
      <p>
  ...
  [
    ...
    <>
      ...
      <p>
        ڕەنگە نووسینی سێ &laquo;ی&raquo; بەدوای یەکتر ڕاستییەکی تاڵ بێت بۆت،
        بەڵام ئیتر وایە و دەبێت لەگەڵی ڕا بێیت. نابێت هەرگیز ئامڕازی دانەپاڵ، جێناو یان هەر پیتێکی کۆتاییی وشەیەک ون بن.
      </p>
      <p>
  ...
  [
    ...
    <>
      ...
      <p>
        ترێکی تریش هەیە کە پاشگرێکە دەچێتە سەر هاوەڵناوی چۆنێتی و چەندێتی،
        نابێت لە هاوەڵناوەکە جیا بکرێتەوە.
      </p>
      <p>
...
].map((v, i) => [<h2 id={String(i + 1)}>{v[0].props.children}</h2>, v[1]])
  .flat();
